...
function configGenerator(Manifest) {
	...
	return {
		...
		// for example if you dont want any module import 'net' for various reason like code only for non browser
		// envirinment
		externals: {
			// net: function() {}
		},
		...
		resolve: {
			...
			// NOTE Aliasing
			// If you want to override some path with another. Good for importing same version of React across
			// different libraries
			alias: {
